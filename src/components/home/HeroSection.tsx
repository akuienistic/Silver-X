    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-custom px-4 text-center">
        ...
        >
          ...
          >
            Award-winning musical icon from South Sudan. CEO of Holyland Music Empire. 
          ...
          >
            <Button variant="hero" size="xl" asChild>
              <a href="https://www.youtube.com/watch?v=BXy4b00rgzs" target="_blank" rel="noopener noreferrer">
                <Play size={20} />
                Watch Latest
              </a>
            </Button>
